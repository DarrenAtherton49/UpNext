...
import kotlinx.android.synthetic.main.item_detail_scrolling_season_item.*
...
class ModelDetailSeasonAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModelDetailScrollingViewHolder {
        return ModelDetailScrollingViewHolder(parent.inflateLayout(R.layout.item_detail_scrolling_season_item), imageLoader).apply {
